...
func toPropertyTotalRows(rows []repository.SumItemPropertiesRow) []dto.PropertyTotalRow {
	totalRows := make([]dto.PropertyTotalRow, len(rows))
	for index, row := range rows {
		totalRows[index] = dto.PropertyTotalRow{
