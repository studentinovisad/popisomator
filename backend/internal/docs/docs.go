...
const docTemplate = `{
    ...
    "paths": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_studentinovisad_popisomator_backend_internal_dto.ItemRequestUpdateRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/item-types/{id}/properties/order": {
            "put": {
                "security": [
                    {
                        "CookieAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "description": "Ordered property IDs",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_studentinovisad_popisomator_backend_internal_dto.ReorderItemTypePropertiesRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/items/stock": {
            "get": {
                ...
                "description": "Items of one type that render the same derived name are one line of stock. Counts how\nmany of each are free to hand out - untouched, and not held under an approved request\n- and flags the lines at or below the type's low_stock_count.",
                "produces": [
                    "application/json"
                ],
                "tags": [
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Item type to count",
                        "name": "type_id",
                        "in": "query",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/github_com_studentinovisad_popisomator_backend_internal_dto.LocationOption"
                            }
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_studentinovisad_popisomator_backend_internal_dto.CreateLocationRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_studentinovisad_popisomator_backend_internal_dto.Location"
                        }
                    },
                    "400": {
                        "description": "invalid request",
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_studentinovisad_popisomator_backend_internal_dto.UpdateLocationRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_studentinovisad_popisomator_backend_internal_dto.NotificationsPage"
                        }
                    },
                    "400": {
                        "description": "invalid limit/offset",
    ...
    "definitions": {
        ...
        "github_com_studentinovisad_popisomator_backend_internal_dto.CreateLocationRequest": {
            "type": "object",
            "required": [
                "name"
            ],
        ...
        "github_com_studentinovisad_popisomator_backend_internal_dto.ItemRequestUpdateRequest": {
            "type": "object",
            "required": [
                "status"
            ],
        ...
        "github_com_studentinovisad_popisomator_backend_internal_dto.Location": {
            "type": "object",
            "properties": {
                "description": {
                    "type": "string"
        ...
        "github_com_studentinovisad_popisomator_backend_internal_dto.LocationOption": {
            "type": "object",
            "properties": {
                "children": {
                    "type": "array",
        ...
        "github_com_studentinovisad_popisomator_backend_internal_dto.Notification": {
            ...
            "properties": {
                ...
                "desc_item_expiry": {
                    "$ref": "#/definitions/github_com_studentinovisad_popisomator_backend_internal_dto.NotificationDescriptor_ItemExpiry"
                },
                "desc_item_request": {
                    "$ref": "#/definitions/github_com_studentinovisad_popisomator_backend_internal_dto.ItemRequest"
                },
                ...
                "kind": {
                    "$ref": "#/definitions/github_com_studentinovisad_popisomator_backend_internal_repository.NotificationKind"
                },
                "read": {
                    "type": "boolean"
                },
        ...
        "github_com_studentinovisad_popisomator_backend_internal_dto.NotificationDescriptor_ItemExpiry": {
            "type": "object",
            "properties": {
                "expiry_type": {
                    "$ref": "#/definitions/github_com_studentinovisad_popisomator_backend_internal_repository.NotifdescExpiryType"
                },
                "item": {
                    "$ref": "#/definitions/github_com_studentinovisad_popisomator_backend_internal_dto.Item"
                }
        ...
        "github_com_studentinovisad_popisomator_backend_internal_dto.NotificationsPage": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_studentinovisad_popisomator_backend_internal_dto.Notification"
                    }
                },
                "limit": {
                    "type": "integer"
        ...
        "github_com_studentinovisad_popisomator_backend_internal_dto.ReorderItemTypePropertiesRequest": {
            "type": "object",
            "required": [
                "property_ids",
                "type_id"
        ...
        "github_com_studentinovisad_popisomator_backend_internal_dto.UpdateLocationRequest": {
            "type": "object",
            "required": [
                "id"
            ],
        ...
        "github_com_studentinovisad_popisomator_backend_internal_repository.NotifdescExpiryType": {
            "type": "string",
            "enum": [
                "expiring_soon",
                "expired"
            ...
            "x-enum-varnames": [
                "NotifdescExpiryTypeExpiringSoon",
                "NotifdescExpiryTypeExpired"
            ]
        },
        "github_com_studentinovisad_popisomator_backend_internal_repository.NotificationKind": {
            "type": "string",
            "enum": [
                "item_request",
                "item_expiry",
